        ...
        <SideBySide>
          ...
          <Text style={{ flex: 1 }}>
            ...
            <p>
              ...
              <br />
              You can play this card in the battle plan, in addition to playing
              a weapon and a defense.
            </p>
            <p>
        ...
        <SideBySide>
          ...
          <Text style={{ flex: 1 }}>
            ...
            <p>
              ...
              <br />
              These special Treachery cards to not count towards your hand
              limit.
            </p>
      ...
      <Spaced>
        ...
        <SideBySide>
          ...
          <Text style={{ flex: 1 }}>
            ...
            <p>
              ...
              <br />
              <em>
                Guild can play it along with a leader disc after having
                activated their fate.
              </em>
            </p>
            <p>
            ...
            <p>
              A Cheap Hero card is always discarded after use. Unless you won
              with Traitor, in that case you can chose to keep or discard.
            </p>
            <p>
        ...
        <SideBySide>
          ...
          <Text style={{ flex: 1 }}>
            ...
            <p>
              You can play this card during the storm phase only, after the
              storm calculation is complete, but before the storm is moved.
            </p>
        ...
        <SideBySide>
          ...
          <Text style={{ flex: 1 }}>
            ...
            <p>
              You can play this card during the storm phase only, after the
              storm calculation is complete (and after Weather Control is
      ...
      <Spaced>
        ...
        <Text columns={2} size={1.7}>
          ...
          <p>
            ...
            <br />
            You must commit to an answer and then you are not allowed to make
            game actions that would make your answer not true.
          </p>
          <p>
            To be clear: you will be locked into future actions via the answer
            you give.
          </p>
          ...
          <ul>
            <li>
              Absolutely, no questions about future truth-trace questions.
            </li>
            <li>
          ...
          <p>
            ...
            discard your Truth Trance card, you do <strong>not</strong> get to
    ...
    <Fragment>
      <Spaced>
            ...
            <Outline variant="generic">
              ...
              <ol>
                <li>
                  ...
                  cancel/block any <strong>other</strong> faction's ability
                  listed on their faction sheet.
                </li>
                <li>
                  During bidding phase, make an infinite bid for a card, take
                  the card without paying.
                </li>
                <li>
        ...
        <Text size={1.7}>
          ...
          <p>
            On each player's faction sheet each advantage that can be karama'd
            is denoted by a "*"-token.
            <br />
            On the second page of their faction sheet is described in detail
            what happens when this ability is blocked/cancelled.
          </p>
          <p>
        ...
        <Text columns={2}>
          ...
          <Outline variant="example">
            <p>
              ...
              voice advantage against you, you can listen to what their voice
              is, but must play the karama before proceeding with further
              actions/revealing.
            </p>
          </Outline>
        </Text>
        ...
        <SideBySide>
          ...
          <Text style={{ flex: 1 }}>
            ...
            <p>
              ...
              kill the opponent's leader unless they have a projectile defense
            ...
            <p>
              Playing this with a lasgun does not cause a lasgun-shield
              explosion.
            </p>
            <p>
...
export function TreacheryCards() {
  return (
    <Fragment>
      <Spaced>
