        ...
        <Spaced>
          ...
          <Text columns={2}>
            <ol>
              <li>
                <p>
                  Place the board on the center of a table (seating at least 6).
                  A recommended minimum size for the table is 60cm by 60cm.
                </p>
              </li>
              <li>
                <p>
                  ...
                  first 6 numbered prediction cards to players. Then have
                  players sit in storm order starting from the "storm start"
                  denoted on the board.
                </p>
              </li>
              <li>
                <p>
                  Each player drafts the faction-token of 1 faction they wish
                  have in play, by places it in the center of the board.{' '}
                  <em>
            ...
            <ol>
              ...
              <li>
                ...
                <p>
                  Place the faction-shield in such a way that the shield is
                  clear to see for other places and it obscures your personal
                  Spice stash.
                </p>
                <p>
            ...
            <Spaced>
              <ol>
                ...
                <li>
                  ...
                  <p>
                    The non-Shai-Halud cards are shuffled, then place 1 card
                    (face down) from this deck on <strong>A</strong> and 1 card
                    (face down) on <strong>B</strong>.
                  </p>
                  <p>
                ...
                <li>
                  <p>
                    Randomize Tech Tokens, and place them in a Stack (face
                    down),
                  </p>
                </li>
                <li>
            ...
            <NonBreaking>
              <Text>
                <ol>
                  ...
                  <li>
                    <p>
                      Every player except the one playing as Harkonnen must
                      chose 1 out of the 4 as their Traitor.
                      <br />
              ...
              <Text>
                ...
                <ol>
                  <li>
                    ...
                    Tleilaxu themselves) places their non-chosen Traitor cards
                    on their faction-token.
                  </li>
                  <li>
                    The player playing as the Bene Tleilaxu faction shuffles
                    each pile on every faction-token & and takes 1 card from
                    each pile.
                  </li>
                  <li>
      ...
      <Spaced>
        ...
        <Text columns={2}>
          ...
          <Text>
            ...
            <p>
              Harkonnen takes 1 extra Treachery card from the Treachery draw
              deck.
            </p>
          </Text>
        </Text>
