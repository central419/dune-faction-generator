...
export const pages = [
    ...
    <Spaced>
      ...
      <Text columns={2} size={1.7}>
        ...
        <p>
          ...
          discard your Truth Trance card, you do <strong>not</strong> get to ask
          another question.
        </p>
      </Text>
      <Text columns={2} size={1.7}>
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }}>
          ...
          <p>
            ...
            Supplies! Treachery cards from the supply, into your hand.
            <br />
          ...
          <p>
            The Supply! Treachery cards can be voiced, like regular Treachery
            cards.
          </p>
          <blockquote>
      ...
      <Spaced>
        ...
        <Text columns={2}>
          <ol>
            <li>
              <p>
                Place the board on the center of a table (seating at least 6). A
                recommended minimum size for the table is 60cm by 60cm.
              </p>
            </li>
            <li>
              <p>
                Sit around a table. It's best if players don't sit directly
                parallel next to each other, but sit in a circle.
                <br />
                If you want to randomize seating, you can randomly deal the
                first 6 numbered prediction cards to players. Then have players
                sit in storm order starting from the "storm start" denoted on
                the board.
              </p>
            </li>
            <li>
              <p>
                Each player drafts the faction-token of 1 faction they wish have
                in play, by places it in the center of the board.{' '}
                <em>
                  Drafting a faction does not mean you'll be playing as that
                  faction.
                </em>
              </p>
            </li>
            <li>
              <p>
                Collect all the faction-tokens from the center of the board, and
                shuffle them thouroughly. Place the faction-tokens as evenly
                spaced as possible around the board on the storm track.
              </p>
              <p>
                The result should be that every player around the table has a
                faction-token placed in front of them.
              </p>
            </li>
          </ol>
          <ol>
            <li>
              <p>
                Players may now trade faction-tokens, but they are not allowed
                to swap seats.
              </p>
              <p>
                What faction-token is in front of you, that faction is the one
                you'll be playing as.
              </p>
            </li>
            <li>
              <p>
                Every players takes all the items specific to the faction they
                are playing, out of the box.
              </p>
              <p>They take their initial Spice out of the Spice bank.</p>
              <p>
                Place the faction-shield in such a way that the shield is clear
                to see for other places and it obscures your personal Spice
                stash.
              </p>
              <p>
                There should be ample room in front of your shield for bribes
                and Tech Tokens.
              </p>
            </li>
          </ol>
      ...
      <Text columns={2}>
        <NonBreaking>
          <Spaced>
            <ol>
              ...
              <li>
                <p>
                  Take all Spice cards, and separate all the Shai-Halud cards.
                </p>
                <p>
                  The non-Shai-Halud cards are shuffled, then place 1 card (face
                  down) from this deck on <strong>A</strong> and 1 card (face
                  down) on <strong>B</strong>.
                </p>
                <p>
                  From the same deck place 1 card (face down) on{' '}
                  <strong>Pa</strong>.
                </p>
                <p>
                  Add 2 Shai-Halud cards and shuffle the deck. Then place 1
              ...
              <li>
                <p>
                  Randomize Tech Tokens, and place them in a Stack (face down),
                </p>
              </li>
              <li>
                <p>
                  Create a Traitor deck by gathering all the Traitor card from
                  the faction that have been drafted. (<strong>C</strong>)
                </p>
              </li>
            </ol>
        ...
        <NonBreaking>
          <Definitions>
            ...
            <dt>
              <Ball style={{ color: '#fff', backgroundColor: '#1B2C43' }}>
                T
              </Ball>
            </dt>
            <dd>Turn tracker</dd>
            ...
            <dt style={{ marginTop: '2vw' }}>
              <Ball style={{ color: '#fff', backgroundColor: '#4B1F1B' }}>
                D1
              </Ball>
            </dt>
            ...
            <dd>
              Pile 2: cards to draw new auction cards from, after P1 is
              exhausted.
            </dd>
            <dt>
              <Ball style={{ color: '#fff', backgroundColor: '#4B1F1B' }}>
            ...
            <dt style={{ marginTop: '2vw' }}>
              <Ball style={{ color: '#fff', backgroundColor: '#2A4270' }}>
                D
              </Ball>
            </dt>
        ...
        <Text columns={2}>
          <NonBreaking>
            <Text>
              <ol>
                <li>
                  <p>
                    Deal 4 Traitor cards from the Traitor deck to every player
                    except the player playing as the Bene Tleilaxu faction.
                  </p>
                </li>
                <li>
                  <p>
                    Every player except the one playing as Harkonnen must chose
                    1 out of the 4 as their Traitor.
                    <br />
                ...
                <li>
                  <p>
                    If Bene Tleilaxu was not one of the drafted factions, then
                    remove the non-chosen and remaining Traitor cards from the
                    game.
                  </p>
                </li>
              </ol>
          ...
          <Outline variant="generic">
            <Text>
              ...
              <ol>
                <li>
                  Instead of removing from the game, each player (except Bene
                  Tleilaxu themselves) places their non-chosen Traitor cards on
                  their faction-token.
                </li>
                <li>
                  The player playing as the Bene Tleilaxu faction shuffles each
                  pile on every faction-token & and takes 1 card from each pile.
                </li>
                <li>
                  If this results in less then 5 Traitor cards in their hand,
                  they draw from the remaining Traitor deck, until they have
                  exactly 5.
                </li>
                <li>
                  When they have 5 Traitor cards, they pick one of them to be
                  their Traitor, by placing their Traitor card (face down)
                  behind their shield.
                </li>
                <li>
                  All Traitor cards that other factions didn't chose are
                  collected into a deck, and this becomes the Bene Tleilaxu
                  FaceDancer draw deck.
                </li>
              </ol>
            </Text>
          </Outline>
      ...
      <Text columns={2}>
        <Outline variant="generic">
          <Text>
            ...
            <ol>
              <li>
                Deal Treachery cards equal to the number of players (including
                Ixian).
              </li>
              <li>
              ...
              <li>
                After looking, Ixians create a deck out of the starting card,
                shuffle it and then deal 1 to each player (including
                themselves).
              </li>
            </ol>
          </Text>
        ...
        <Text>
          ...
          <p>
            Harkonnen takes 1 extra Treachery card from the Treachery draw deck.
          </p>
        </Text>
      </Text>
    </Spaced>
  ...
  <Fragment>
    <Spaced>
      ...
      <Text>
        <p>
          The Storm Marker is placed at a random location along the map edge
          using either a D18 dice (recommended) or using the following
          procedure:
        </p>
        <ol>
          <li>
